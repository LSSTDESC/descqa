...
color_DEEP2 = _ValidationConfig('ColorDistributionTest',
         data_dir='DEEP2',
         data_name='DEEP2',
         raw_data_fname='/scratch2/scratchdirs/yymao/descqa-backup/rongpu-descqa/DEEP2_uniq_Terapix_Subaru.fits',
...
color_SDSS = _ValidationConfig('ColorDistributionTest',
         data_dir='SDSS',
         data_name='SDSS',
         raw_data_fname='/scratch2/scratchdirs/yymao/descqa-backup/rongpu-descqa/SpecPhoto_sdss_extinction_corrected_trimmed.fit',
         colors=['u-g','g-r','r-i','i-z'],
         translate={'u':'SDSS_u:observed:','g':'SDSS_g:observed:','r':'SDSS_r:observed:','i':'SDSS_i:observed:','z':'SDSS_z:observed:'},
         limiting_band='r',
         limiting_mag=17.77,
