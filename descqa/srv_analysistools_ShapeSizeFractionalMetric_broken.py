...
class TestMetric(BaseValidationTest):
    ...
    def run_on_single_catalog(self, catalog_instance, catalog_name, output_dir):
        ...
        if rank==0:
            ...
            #metric = self.wPerpAction.produce(stage2)
            ...
            #plot = self.shapesize_plot(recvbuf,band='r',plotInfo=_StandinPlotInfo(),skymap='DC2')
            print(self.shapesize_plot.prep)
            stage1 = self.shapesize_plot.prep(recvbuf)#,band='r')
            #print(self.shapesize_plot.prep)
            stage2 = self.shapesize_plot.process(stage1)#,band='r')
            plot = self.shapesize_plot.produce(stage2, plotInfo=_StandinPlotInfo())
