...
print '<!-- %s %s -->' % (test_prefix,catalog_prefix)
print '</head>'
...
#print '<a href="https://portal-auth.nersc.gov/project/lsst/descqa/flashTestView/index.cgi?run=2017-01-09_5&test_prefix=&catalog_prefix=Galacticus">&lt; Back to "matrix"</a>'
